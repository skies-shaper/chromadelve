...
function dynamicContent_importImages(){
	...
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/OS_Omu.png" id="GUI_cutscenes_OS_Omu"/>'
	...
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0000.png" id="GUI_cutscenes_opening fog frames_frame_0000"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0001.png" id="GUI_cutscenes_opening fog frames_frame_0001"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0002.png" id="GUI_cutscenes_opening fog frames_frame_0002"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0003.png" id="GUI_cutscenes_opening fog frames_frame_0003"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0004.png" id="GUI_cutscenes_opening fog frames_frame_0004"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0005.png" id="GUI_cutscenes_opening fog frames_frame_0005"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0006.png" id="GUI_cutscenes_opening fog frames_frame_0006"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0007.png" id="GUI_cutscenes_opening fog frames_frame_0007"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0008.png" id="GUI_cutscenes_opening fog frames_frame_0008"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0009.png" id="GUI_cutscenes_opening fog frames_frame_0009"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0010.png" id="GUI_cutscenes_opening fog frames_frame_0010"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0011.png" id="GUI_cutscenes_opening fog frames_frame_0011"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0012.png" id="GUI_cutscenes_opening fog frames_frame_0012"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0013.png" id="GUI_cutscenes_opening fog frames_frame_0013"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0014.png" id="GUI_cutscenes_opening fog frames_frame_0014"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0015.png" id="GUI_cutscenes_opening fog frames_frame_0015"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0016.png" id="GUI_cutscenes_opening fog frames_frame_0016"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0017.png" id="GUI_cutscenes_opening fog frames_frame_0017"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0018.png" id="GUI_cutscenes_opening fog frames_frame_0018"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0019.png" id="GUI_cutscenes_opening fog frames_frame_0019"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0020.png" id="GUI_cutscenes_opening fog frames_frame_0020"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0021.png" id="GUI_cutscenes_opening fog frames_frame_0021"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0022.png" id="GUI_cutscenes_opening fog frames_frame_0022"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0023.png" id="GUI_cutscenes_opening fog frames_frame_0023"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0024.png" id="GUI_cutscenes_opening fog frames_frame_0024"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0025.png" id="GUI_cutscenes_opening fog frames_frame_0025"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0026.png" id="GUI_cutscenes_opening fog frames_frame_0026"/>'
	document.getElementById("imgstore").innerHTML += '<img src="imgs/GUI/cutscenes/opening fog frames/frame_0027.png" id="GUI_cutscenes_opening fog frames_frame_0027"/>'
